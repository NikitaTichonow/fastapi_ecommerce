...
SECRET_KEY = "f0f142bdcc963931def3f063df8816e9a7e1e20197f3a5da4a1f7a5f76d2312c"
ALGORITHM = "HS256"
...
async def login(
    ...
    token = await create_access_token(
        user.username, user.id, user.is_admin, user.is_supplier, user.is_customer, expires_delta=timedelta(minutes=20)
    )
